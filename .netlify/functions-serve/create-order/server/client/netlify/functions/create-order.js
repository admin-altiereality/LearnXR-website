...
var require_razorpay = __commonJS({
  "server/client/netlify/functions/node_modules/razorpay/dist/razorpay.js"(exports2, module2) {
    ...
    module2.exports = Razorpay2;
  }
});

// server/client/netlify/functions/create-order.js
var Razorpay = require_razorpay();
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const { amount, currency, planId, receipt } = body;
    console.log("Order request:", { amount, currency, planId, receipt });
