/**
 * Denormalized metadata for WhatsApp / Conversations inbox (CRM fields, handoff flags).
 * Twilio remains source of truth for message bodies; this collection powers the action panel + alerts.
 */
